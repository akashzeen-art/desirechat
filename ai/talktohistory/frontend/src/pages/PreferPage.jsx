...
export default function PreferPage() {
  ...
  const youLabel = userGender === "male" ? t("common.boy") : t("common.girl");
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-white/70 border border-dark/8 rounded-full px-4 py-1.5 mb-5 shadow-sm">
              ...
              <span className="text-xs font-bold uppercase tracking-[0.18em] text-secondary">
                {t("prefer.step2", { label: youLabel })}
              </span>
            </div>
            <h1 className="font-headline text-3xl sm:text-5xl font-extrabold text-dark mb-3">
              {t("prefer.whoMeet", { name: nameSuffix })}
            </h1>
            <p className="text-muted text-base sm:text-lg max-w-sm mx-auto">{t("prefer.chooseSub")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
            <button onClick={() => pick("female")}
              ...
              <div className="p-7">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-primary mb-2 block">{t("prefer.companions12")}</span>
                <h2 className="font-display text-2xl font-extrabold text-dark mb-2">{t("prefer.girls")}</h2>
                <p className="text-muted text-sm leading-relaxed">{t("prefer.regions")}</p>
            ...
            <button onClick={() => pick("male")}
              ...
              <div className="p-7">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-secondary mb-2 block">{t("prefer.companions12")}</span>
                <h2 className="font-display text-2xl font-extrabold text-dark mb-2">{t("prefer.boys")}</h2>
                <p className="text-muted text-sm leading-relaxed">{t("prefer.regions")}</p>
